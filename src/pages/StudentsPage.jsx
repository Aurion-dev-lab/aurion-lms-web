...
import { Search, PlayCircle, ClipboardList, Download, Settings } from 'lucide-react';
  ...
  return (
    <div className="space-y-0">
      ...
      <div className="pt-32 pb-16 bg-slate-50 overflow-hidden relative">
        <div className="absolute top-20 left-1/4 w-80 h-80 bg-orange-100 rounded-full blur-3xl opacity-60 pointer-events-none"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-50 text-slate-800 text-sm font-bold mb-8 shadow-xs border border-orange-200/60">
              <span className="text-orange-600">✌</span> For Students
            </div>
            <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight mb-6 leading-tight">
              Learn on <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-600">Your Own Terms.</span>
            </h1>
            ...
            <div className="relative max-w-lg mx-auto">
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-200 to-amber-200 rounded-full blur opacity-50"></div>
              <div className="relative bg-white border border-slate-100 shadow-xl rounded-full p-2 flex items-center h-16">
                ...
                />
                <button className="w-12 h-12 bg-orange-500 hover:bg-orange-600 rounded-full flex items-center justify-center text-white transition-transform hover:scale-105 shadow-md flex-shrink-0 cursor-pointer">
            ...
            <div className="bg-slate-50 rounded-[3rem] p-10 md:p-16 border border-slate-100">
              <div className="max-w-3xl mb-12">
                <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-6">
                  ...
                  <span className="text-orange-500 font-medium italic">Experience.</span>
                </h2>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-xs">
              ...
              <div className="bg-slate-900 rounded-[3rem] p-8 sm:p-16 text-white shadow-2xl flex flex-col md:flex-row items-center gap-12 overflow-hidden relative">
                ...
                <div className="md:w-1/2 space-y-6 relative z-10">
                  <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight">
                    Customize Absolutely <span className="italic text-orange-400">Everything.</span>
                  </h2>
                  ...
                  <ul className="space-y-4 font-medium text-slate-200 mt-8">
                    <li className="flex items-center gap-3">
                      <div className="bg-orange-500/20 p-1.5 rounded-full">
                        <span className="text-orange-400 block w-3 h-3 bg-orange-400 rounded-full"></span>
                      </div>
                ...
                <div className="md:w-1/2 w-full bg-white/5 rounded-[2rem] p-8 border border-white/10 backdrop-blur flex items-center justify-center min-h-[300px] relative z-10">
                  <div className="text-center space-y-6">
                    <div className="w-20 h-20 bg-orange-500 rounded-2xl shadow-lg flex items-center justify-center mx-auto text-white animate-float transform rotate-3">
                      <Settings className="w-10 h-10" />
                    </div>
                    <p className="text-orange-100 font-medium text-lg">Personalization Engine UI</p>
                  </div>
                </div>
              </div>
            </div>
